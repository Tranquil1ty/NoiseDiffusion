...
img1 = Image.open('controlnet/sample_imgs/peach1.png').resize((768, 768))
img2 = Image.open('controlnet/sample_imgs/peach2.png').resize((768, 768))
...
CM.interpolate_new(img1, img2, prompt=prompt, n_prompt=n_prompt,  ddim_steps=200, guide_scale=10, out_dir='controlnet/sample_results/peach')
